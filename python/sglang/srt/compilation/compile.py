...
def install_torch_compiled(
    ...
    *,
    ...
    def _ensure_compiled(self, *args, **kwargs):
        ...
        # The prefill runner compiles once per captured shape (58 buckets at
        # --chunked-prefill-size 8192), well past Dynamo's default limit of 8, and
        # capture then aborts with FailOnRecompileLimitHit. 1024 matches what
        # torch_compile_decoration.py already sets on the full-torch-compile path.
