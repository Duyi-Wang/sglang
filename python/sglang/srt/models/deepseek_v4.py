...
class DeepseekV4DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        # degrades to a bare `yield`, so skipping it is semantically identical -- but
        # it keeps self_attn out of a _GeneratorContextManager, inside which Dynamo
        # refuses to graph break and tc_piecewise prefill fails to compile.
