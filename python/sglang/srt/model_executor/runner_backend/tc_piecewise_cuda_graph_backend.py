        ...
        with enable_tc_piecewise_cuda_graph():
            try:
                ...
                with enable_torch_compile_warmup():
                    ...
                    # once at the largest shape and relying on dynamic shapes does
                    # not hold: maybe_mark_dynamic is advisory, the guard specializes
                    # to the traced shape, every other bucket recompiles, and a
