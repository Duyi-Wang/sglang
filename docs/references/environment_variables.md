...
| Environment Variable | Description | Default Value |
| --- | --- | --- |
| `SGLANG_MORI_FP8_DISP` | Force FP8 dispatch for all MoRI-EP layers (overrides auto-detection from weight dtype) | `"false"` |
| `SGLANG_MORI_FP4_DISP` | Force MXFP4 dispatch for all MoRI-EP layers (overrides auto-detection from weight dtype) | `"false"` |
